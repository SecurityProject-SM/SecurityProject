...
<div id="wrapper">
    ...
    <div class="content-wrapper d-flex justify-content-center"> <!-- 중앙 정렬을 위해 추가된 클래스 -->
        <div class="container-fluid">

            <div class="row mt-3 justify-content-center"> <!-- 카드 중앙 정렬 -->
                <div class="col-lg-10"> <!-- 카드 너비 조정 -->
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title text-center">공지사항 작성</div> <!-- 제목을 가운데 정렬 -->
                            <hr>
