...
<head>
  ...
  <style>
    ...
    /* 층 위치 및 크기 */
    .floor-left5f { top: 21px; left: 82px; width: 392px; height: 159px; background-image: url('<c:url value="/img/building/left5f3.png"/>');
      filter: invert(31%) sepia(97%) saturate(375%) hue-rotate(82deg) brightness(94%) contrast(92%);}
    .floor-right5f { top: 105px; left: 520px; width: 209px; height: 102px; background-image: url('<c:url value="/img/building/right5f.png"/>');
      filter: invert(31%) sepia(97%) saturate(375%) hue-rotate(82deg) brightness(94%) contrast(92%);}

    .floor-left4f { top: 96px; left: 76px; width: 398px; height: 134px; background-image: url('<c:url value="/img/building/left4f.png"/>');
      filter: invert(31%) sepia(97%) saturate(375%) hue-rotate(82deg) brightness(94%) contrast(92%);}
    .floor-right4f { top: 162px; left: 518px; width: 213px; height: 85px; background-image: url('<c:url value="/img/building/right4f.png"/>');
      filter: invert(31%) sepia(97%) saturate(375%) hue-rotate(82deg) brightness(94%) contrast(92%);}


    .floor-left3f { top: 161px; left: 67px; width: 405px; height: 123px; background-image: url('<c:url value="/img/building/left3f.png"/>');
      filter: invert(31%) sepia(97%) saturate(375%) hue-rotate(82deg) brightness(94%) contrast(92%);}
    .floor-right3f { top: 210px; left: 518px; width: 215px; height: 82px; background-image: url('<c:url value="/img/building/right3f.png"/>');
      filter: invert(31%) sepia(97%) saturate(375%) hue-rotate(82deg) brightness(94%) contrast(92%);}

    .floor-left2f { top: 227px; left: 60px; width: 411px; height: 111px; background-image: url('<c:url value="/img/building/left2f.png"/>');
      filter: invert(31%) sepia(97%) saturate(375%) hue-rotate(82deg) brightness(94%) contrast(92%);}
    .floor-right2f { top: 259px; left: 518px; width: 219px; height: 77px; background-image: url('<c:url value="/img/building/right2f.png"/>');
      filter: invert(31%) sepia(97%) saturate(375%) hue-rotate(82deg) brightness(94%) contrast(92%);}

    .floor-left1f { top: 295px; left: 52px; width: 419px; height: 99px; background-image: url('<c:url value="/img/building/left1f.png"/>');
      filter: invert(31%) sepia(97%) saturate(375%) hue-rotate(82deg) brightness(94%) contrast(92%);}
    .floor-right1f { top: 310px; left: 520px; width: 220px; height: 69px; background-image: url('<c:url value="/img/building/right1f.png"/>');
      filter: invert(31%) sepia(97%) saturate(375%) hue-rotate(82deg) brightness(94%) contrast(92%);}
  </style>
